    ...
    <div className="min-h-screen bg-gray-950 text-white">
      <section className="relative overflow-hidden bg-gradient-to-br from-purple-900 via-gray-950 to-pink-900 px-6 py-28 text-center">
        ...
        <div className="relative">
          ...
          <p className="mx-auto mb-8 max-w-xl text-lg text-purple-200">${v.tagline}</p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        ...
        <p className="mb-10 text-center text-sm text-gray-400">Hand-picked ${v.niche} items</p>
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      <section className="border-b border-gray-800 px-6 py-12 text-center">
        <h1 className="text-4xl font-black">Shop ${v.brandName}</h1>
        <p className="mt-2 text-sm text-gray-400">Browse our full ${v.niche} collection</p>
      </section>
