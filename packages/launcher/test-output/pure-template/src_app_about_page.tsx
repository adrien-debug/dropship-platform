  ...
  return (
    <div className="bg-gray-950 min-h-screen text-white">
      <section className="mx-auto max-w-4xl px-6 py-24">
        <h1 className="mb-6 text-5xl font-black">About AnimeStore</h1>
        <div className="space-y-6 text-lg leading-relaxed opacity-80">
          <p>AnimeStore was born from a passion for anime. We curate only the finest products for enthusiasts who demand quality.</p>
          ...
          <p>Our mission: make premium anime products accessible to everyone, everywhere.</p>
        </div>
      </section>
