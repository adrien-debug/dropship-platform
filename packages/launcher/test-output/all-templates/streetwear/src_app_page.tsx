    ...
    <div className="min-h-screen bg-black text-white">
      <section className="relative overflow-hidden bg-black px-6 py-28 text-center">
        ...
        <div className="relative">
          <h1 className="mb-4 text-7xl font-black uppercase tracking-tighter lg:text-9xl">TestStreetwear</h1>
          <p className="mb-8 text-sm font-medium uppercase tracking-[0.5em] text-gray-400">Premium streetwear products</p>
