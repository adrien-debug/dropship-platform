  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      <section className="px-6 py-16 text-center">
        <h1 className="font-serif text-4xl font-light tracking-widest">TestLuxury Collection</h1>
        <p className="mt-2 text-xs tracking-[0.2em] uppercase text-gray-500">Premium luxury</p>
      </section>
