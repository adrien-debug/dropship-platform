  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      <section className="relative bg-gradient-to-b from-amber-950/30 via-gray-950 to-gray-950 px-6 py-32 text-center">
        <h1 className="mb-4 font-serif text-6xl font-light tracking-widest lg:text-8xl">TestLuxury</h1>
        <p className="mx-auto mb-8 max-w-lg text-sm tracking-[0.3em] uppercase text-amber-200/60">Premium luxury products</p>
