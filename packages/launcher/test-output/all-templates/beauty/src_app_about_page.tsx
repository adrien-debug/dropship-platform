  ...
  return (
    <div className="bg-rose-50 min-h-screen text-rose-900">
      <section className="mx-auto max-w-4xl px-6 py-24">
        <h1 className="mb-6 text-5xl font-black">About TestBeauty</h1>
        <div className="space-y-6 text-lg leading-relaxed opacity-80">
          <p>TestBeauty was born from a passion for beauty. We curate only the finest products for enthusiasts who demand quality.</p>
          ...
          <p>Our mission: make premium beauty products accessible to everyone, everywhere.</p>
        </div>
      </section>
