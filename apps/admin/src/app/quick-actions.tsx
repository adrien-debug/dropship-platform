...
const QUICK_ACTIONS = [
  {
    ...
    icon: '🚀',
    description: 'Pipeline complet : produits → design → deploy',
    href: '/sites/new',
  ...
  },
  {
    ...
    icon: '🔥',
    description: 'Decouvrir les tendances du moment',
    href: '/discover',
    color: 'bg-orange-50 border-orange-200 hover:bg-orange-100',
  },
  {
    id: 'sync-catalog',
    label: 'Sync fournisseurs',
    icon: '🔄',
    description: 'Synchroniser les catalogues CJ / AliExpress',
    href: '/catalogs',
  ...
  },
  {
    ...
    icon: '📦',
    description: 'Importer dans Medusa depuis un fournisseur',
  ...
  },
  {
    ...
    icon: '📣',
    description: 'Google Ads / Meta Ads / SEO',
    href: '/marketing/new',
    color: 'bg-pink-50 border-pink-200 hover:bg-pink-100',
  },
  {
    id: 'health-check',
    label: 'Sante des services',
    icon: '💚',
    description: 'GPU1, GPU2, Medusa, Storefronts',
    href: '/gpu',
