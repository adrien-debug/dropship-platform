...
import type { StorePublicAnalytics } from '@/lib/store-config';
import type { ConsentState } from '@/lib/consent';

interface Props {
  ids: StorePublicAnalytics;
  consent: ConsentState;
}

/**
 * Server-rendered tag injector. Reads the per-store IDs (Pixel / GA4 /
 * Clarity) and the visitor's consent state, and only emits the
