  ...
  return (
    <section className="border border-zinc-200 bg-zinc-50 rounded-xl overflow-hidden">
      ...
      <div className="p-6 space-y-4">
        <div>
          <label htmlFor="custom-domain" className="block text-xs font-medium text-zinc-600 mb-1.5">
            Domaine
          </label>
          <input
            id="custom-domain"
        ...
        <div className="text-xs text-zinc-400 bg-zinc-50 rounded-lg p-3 space-y-1 max-w-lg">
          <p className="font-medium text-zinc-600">Configuration DNS requise</p>
          <p>
        ...
        <div className="flex items-center gap-3 pt-1">
          ...
          {saved && !dirty && (
            <span className="text-xs text-indigo-600">Enregistre.</span>
          )}
