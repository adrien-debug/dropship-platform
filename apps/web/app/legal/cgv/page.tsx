...
export default function CGV() {
  return (
    <>
      <h1 className="text-3xl font-bold text-zinc-900 mb-2">Conditions Générales de Vente</h1>
      <p className="text-sm text-zinc-500 mb-8">Dernière mise à jour : 27 avril 2026</p>

      <h2 className="text-xl font-semibold text-zinc-900 mt-8 mb-3">1. Objet</h2>
      ...
      <h2 className="text-xl font-semibold text-zinc-900 mt-8 mb-3">2. Produits</h2>
      <p className="text-zinc-700">
      ...
      <h2 className="text-xl font-semibold text-zinc-900 mt-8 mb-3">3. Prix</h2>
      <p className="text-zinc-700">
      ...
      <h2 className="text-xl font-semibold text-zinc-900 mt-8 mb-3">4. Commande</h2>
      <p className="text-zinc-700">
      ...
      <h2 className="text-xl font-semibold text-zinc-900 mt-8 mb-3">5. Paiement</h2>
      <p className="text-zinc-700">
      ...
      <h2 className="text-xl font-semibold text-zinc-900 mt-8 mb-3">6. Livraison</h2>
      <p className="text-zinc-700">
      ...
      <h2 className="text-xl font-semibold text-zinc-900 mt-8 mb-3">7. Droit de rétractation</h2>
      <p className="text-zinc-700">
        ...
        <a href="mailto:adrien@hearstcorporation.io" className="text-indigo-600 hover:underline">adrien@hearstcorporation.io</a>. Les frais de retour sont à la charge du Client. Le remboursement intervient dans un délai maximum de 14 jours après réception du bien retourné en parfait état.
      </p>
      <p className="text-zinc-700 mt-3">
      ...
      <h2 className="text-xl font-semibold text-zinc-900 mt-8 mb-3">8. Garanties</h2>
      <p className="text-zinc-700">
        ...
        <a href="mailto:adrien@hearstcorporation.io" className="text-indigo-600 hover:underline">adrien@hearstcorporation.io</a> sous 30 jours avec photos à l’appui.
      </p>

      <h2 className="text-xl font-semibold text-zinc-900 mt-8 mb-3">9. Responsabilité</h2>
      <p className="text-zinc-700">
      ...
      <h2 className="text-xl font-semibold text-zinc-900 mt-8 mb-3">10. Données personnelles</h2>
      <p className="text-zinc-700">
      ...
      <h2 className="text-xl font-semibold text-zinc-900 mt-8 mb-3">11. Litiges</h2>
      <p className="text-zinc-700">
        ...
        <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noreferrer" className="text-indigo-600 hover:underline">ec.europa.eu/consumers/odr</a>. À défaut de résolution amiable, les tribunaux français sont seuls compétents.
      </p>
    </>
  );
}
